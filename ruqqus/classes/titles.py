...
TITLE_DATA={
    1: {'color': 'aa8855',
        ...
        'expr': "user.boards_created.first()",
        'kind': 1,
        'text': ', Guildmaker'},
    2: {'color': '603abb',
    ...
    24: {'color': 'aa8855',
        ...
        'expr': "g.db.query(Board).filter(Board.creator_id==g.user.id, Board.stored_subscriber_count>=10).first()",
        'kind': 1,
        'text': ', Guildbuilder'},
    25: {'color': 'aa8855',
        'description': 'A Guild you created grows past 100 members.',
        'expr': "g.db.query(Board).filter(Board.creator_id==g.user.id, stored_subscriber_count>=100).first()",
        'kind': 1,
        'text': ', Guildsmith'},
    26: {'color': 'aa8855',
        'description': 'A Guild you created grows past 1,000 members.',
        'expr': "g.db.query(Board).filter(Board.creator_id==g.user.id, stored_subscriber_count>=1000).first()",
        'kind': 1,
        'text': ', Guildmaster'},
    27: {'color': 'aa8855',
        'description': 'A Guild you created grows past 10,000 members.',
        'expr': "g.db.query(Board).filter(Board.creator_id==g.user.id, Board.stored_subscriber_count>=10000).first()",
        'kind': 1,
        'text': ', Arch Guildmaster'},
    28: {'color': 'aa8855',
        'description': 'A Guild you created grows past 100,000 members.',
        'expr': "g.db.query(Board).filter(Board.creator_id==g.user.id, Board.stored_subscriber_count>=100000).first()",
        'kind': 1,
        'text': ', Guildlord'},
    29: {'color': 'aa8855',
        'description': 'A Guild you created grows past 1,000,000 members.',
        'expr': "g.db.query(Board).filter(Board.creator_id==g.user.id, Board.stored_subscriber_count>=1000000).first()",
        'kind': 1,
