...
TITLE_DATA={
    1: {'color': 'aa8855',
        ...
        'expr': "g.db.query(Board).filter_by(creator_id=user.id).count()",
        'kind': 1,
        'text': ', Guildmaker'},
    2: {'color': '603abb',
    ...
    24: {'color': 'aa8855',
        ...
        'expr': "g.db.query(Board).filter(Board.creator_id==user.id, Board.stored_subscriber_count>=10).count()",
        'kind': 1,
        'text': ', Guildbuilder'},
    25: {'color': 'aa8855',
        'description': 'A Guild you created grows past 100 members.',
        'expr': "g.db.query(Board).filter(Board.creator_id==user.id, stored_subscriber_count>=100).count()",
        'kind': 1,
        'text': ', Guildsmith'},
    26: {'color': 'aa8855',
        'description': 'A Guild you created grows past 1,000 members.',
        'expr': "g.db.query(Board).filter(Board.creator_id==user.id, stored_subscriber_count>=1000).count()",
        'kind': 1,
        'text': ', Guildmaster'},
    27: {'color': 'aa8855',
        'description': 'A Guild you created grows past 10,000 members.',
        'expr': "g.db.query(Board).filter(Board.creator_id==user.id, Board.stored_subscriber_count>=10000).count()",
        'kind': 1,
        'text': ', Arch Guildmaster'},
    28: {'color': 'aa8855',
        'description': 'A Guild you created grows past 100,000 members.',
        'expr': "g.db.query(Board).filter(Board.creator_id==user.id, Board.stored_subscriber_count>=100000).count()",
        'kind': 1,
        'text': ', Guildlord'},
    29: {'color': 'aa8855',
        'description': 'A Guild you created grows past 1,000,000 members.',
        'expr': "g.db.query(Board).filter(Board.creator_id==user.id, Board.stored_subscriber_count>=1000000).count()",
        'kind': 1,
