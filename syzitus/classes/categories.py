...
SUBCAT_DATA={
    ...
    46: {'cat_id': 15, 'name': 'Mechanics',         'icon': 'fa-gears', 'icon_text': ''}, # overlaps with Engineering!
    ...
    71: {'cat_id': 4,  'name': f'{app.config["SITE_NAME"]} Meta', 'icon': 'fa-podium', 'icon_text': 'meta'},
