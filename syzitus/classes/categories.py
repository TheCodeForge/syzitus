...
SUBCAT_DATA={
    ...
    6:  {'cat_id': 9,  'name': 'Career',            'icon': 'fa-user-tie', 'icon_text': ''},
    ...
    22: {'cat_id': 2,  'name': 'Entrepreneurship',  'icon': 'fa-podium', 'icon_text': ''},
    ...
    28: {'cat_id': 8,  'name': 'Fitness',           'icon': 'fa-podium', 'icon_text': ''},
    29: {'cat_id': 9,  'name': 'Food',              'icon': 'fa-podium', 'icon_text': ''},
    30: {'cat_id': 15, 'name': 'Gadgets',           'icon': 'fa-podium', 'icon_text': ''},
    31: {'cat_id': 6,  'name': 'Gaming news',       'icon': 'fa-podium', 'icon_text': ''},
    32: {'cat_id': 13, 'name': 'Hard Sciences',     'icon': 'fa-podium', 'icon_text': ''},
    33: {'cat_id': 15, 'name': 'Hardware',          'icon': 'fa-podium', 'icon_text': ''},
    34: {'cat_id': 15, 'name': 'Help',              'icon': 'fa-podium', 'icon_text': ''},
    35: {'cat_id': 3,  'name': 'History',           'icon': 'fa-podium', 'icon_text': ''},
    36: {'cat_id': 12, 'name': 'Identity Politics', 'icon': 'fa-podium', 'icon_text': ''},
    37: {'cat_id': 14, 'name': 'Individual',        'icon': 'fa-podium', 'icon_text': ''},
    38: {'cat_id': 5,  'name': 'Influencers',       'icon': 'fa-podium', 'icon_text': ''},
    39: {'cat_id': 3,  'name': 'Language',          'icon': 'fa-podium', 'icon_text': ''},
    40: {'cat_id': 12, 'name': 'Left',              'icon': 'fa-podium', 'icon_text': ''},
    41: {'cat_id': 12, 'name': 'Libertarian',       'icon': 'fa-podium', 'icon_text': ''},
    42: {'cat_id': 1,  'name': 'Literature',        'icon': 'fa-podium', 'icon_text': ''},
    43: {'cat_id': 11, 'name': 'Local',             'icon': 'fa-podium', 'icon_text': ''},
    44: {'cat_id': 2,  'name': 'Management',        'icon': 'fa-podium', 'icon_text': ''},
    45: {'cat_id': 13, 'name': 'Mathematics',       'icon': 'fa-podium', 'icon_text': ''},
