...
SUBCAT_DATA={
    1:  {'cat_id': 12, 'name': 'Activism',          'icon': 'fa-person-sign', 'icon_text': ''},
    ...
    5:  {'cat_id': 9,  'name': 'Beauty',            'icon': 'fa-lips', 'icon_text': ''},
    ...
    12: {'cat_id': 6,  'name': 'Console',           'icon': 'fa-gamepad', 'icon_text': ''},
    13: {'cat_id': 3,  'name': 'Counter-Culture',   'icon': 'fa-house-person-leave', 'icon_text': ''},
    14: {'cat_id': 7,  'name': 'Crafts',            'icon': 'fa-pen-paintbrush', 'icon_text': ''},
    15: {'cat_id': 3,  'name': 'Cuisine',           'icon': 'fa-pot-food', 'icon_text': ''},
    16: {'cat_id': 7,  'name': 'DIY',               'icon': 'fa-hammer', 'icon_text': ''},
    17: {'cat_id': 1,  'name': 'Dance',             'icon': 'fa-shoe-prints', 'icon_text': ''},
    18: {'cat_id': 10, 'name': 'Dank',              'icon': 'fa-face-laugh-squint', 'icon_text': ''},
    19: {'cat_id': 6,  'name': 'Development',       'icon': 'fa-alien-8bit', 'icon_text': ''},
    20: {'cat_id': 4,  'name': 'Drama',             'icon': 'fa-popcorn', 'icon_text': ''},
    21: {'cat_id': 15, 'name': 'Engineering',       'icon': 'fa-oil-well', 'icon_text': ''},
    ...
    38: {'cat_id': 5,  'name': 'Influencers',       'icon': 'fa-camcorder', 'icon_text': ''},
    39: {'cat_id': 3,  'name': 'Language',          'icon': 'fa-language', 'icon_text': ''},
    40: {'cat_id': 12, 'name': 'Left',              'icon': 'fa-democrat', 'icon_text': ''},
    41: {'cat_id': 12, 'name': 'Libertarian',       'icon': 'fa-snake', 'icon_text': ''},
    42: {'cat_id': 1,  'name': 'Literature',        'icon': 'fa-book-open-cover', 'icon_text': ''},
    43: {'cat_id': 11, 'name': 'Local',             'icon': 'fa-map-location-dot', 'icon_text': ''},
    ...
    58: {'cat_id': 6,  'name': 'PC',                'icon': 'fa-desktop', 'icon_text': ''},
    59: {'cat_id': 14, 'name': 'Partner',           'icon': 'fa-racquet', 'icon_text': ''},
    60: {'cat_id': 9,  'name': 'Personal Finance',  'icon': 'fa-hand-holding-dollar', 'icon_text': ''},
    61: {'cat_id': 3,  'name': 'Philosophy',        'icon': 'fa-thought-bubble', 'icon_text': ''},
    62: {'cat_id': 1,  'name': 'Photography',       'icon': 'fa-camera', 'icon_text': ''},
    63: {'cat_id': 10, 'name': 'Political',         'icon': 'fa-face-grin-beam-sweat', 'icon_text': ''},
    64: {'cat_id': 2,  'name': 'Product',           'icon': 'fa-shop', 'icon_text': ''},
    65: {'cat_id': 15, 'name': 'Programming',       'icon': 'fa-code', 'icon_text': ''},
    66: {'cat_id': 6,  'name': 'Puzzle',            'icon': 'fa-puzzle', 'icon_text': ''},
    67: {'cat_id': 4,  'name': 'Q&A',               'icon': 'fa-comments-question-check', 'icon_text': ''},
    68: {'cat_id': 9,  'name': 'Relationships',     'icon': 'fa-house-chimney-heart', 'icon_text': ''},
    69: {'cat_id': 3,  'name': 'Religion',          'icon': 'fa-hands-praying', 'icon_text': ''},
    70: {'cat_id': 12, 'name': 'Right',             'icon': 'fa-republican', 'icon_text': ''},
    71: {'cat_id': 4,  'name': f'{app.config["SITE_NAME"]} Meta', 'icon': 'fa-comment-quote', 'icon_text': ''},
    72: {'cat_id': 1,  'name': 'Sculpture',         'icon': 'fa-cubes', 'icon_text': ''},
    73: {'cat_id': 4,  'name': 'Serious',           'icon': 'fa-message-pen', 'icon_text': ''},
    74: {'cat_id': 7,  'name': 'Skills',            'icon': 'fa-screwdriver-wrench', 'icon_text': ''},
    75: {'cat_id': 13, 'name': 'Soft Sciences',     'icon': 'fa-brain', 'icon_text': ''},
    76: {'cat_id': 15, 'name': 'Software',          'icon': 'fa-display-code', 'icon_text': ''},
    77: {'cat_id': 13, 'name': 'Space',             'icon': 'fa-rocket-launch', 'icon_text': ''},
    78: {'cat_id': 2,  'name': 'Startups',          'icon': 'fa-phone-office', 'icon_text': ''},
    79: {'cat_id': 8,  'name': 'Support',           'icon': 'fa-users-medical', 'icon_text': ''},
    80: {'cat_id': 6,  'name': 'Tabletop',          'icon': 'fa-dice', 'icon_text': ''},
    81: {'cat_id': 14, 'name': 'Team',              'icon': 'fa-screen-users', 'icon_text': ''},
    82: {'cat_id': 1,  'name': 'Theater',           'icon': 'fa-masks-theater', 'icon_text': ''},
    83: {'cat_id': 11, 'name': 'Upbeat',            'icon': 'fa-smile', 'icon_text': ''},
    84: {'cat_id': 1,  'name': 'Visual Arts',       'icon': 'fa-paintbrush-pencil', 'icon_text': ''},
    85: {'cat_id': 10, 'name': 'Wholesome',         'icon': 'fa-family', 'icon_text': ''},
    86: {'cat_id': 11, 'name': 'World',             'icon': 'fa-globe', 'icon_text': ''}
 }
